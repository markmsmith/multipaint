...
define('smartboard-amd-1.1.0',['jquery1.7.1'],function ($) {
    ...
    function initializeSMARTBoard() {
            ...
            window._SB_dispatch = function (packet) {
                ...
                if (packet['type'] == "onBoardStateChange") {
                    if (SB.statusChanged) {
                        ...
                        if (boardAttached) {
                            checkWDKServerVersion(function() {SB.statusChanged("Connected");});
                        } else {
                            checkWDKServerVersion(function() {SB.statusChanged("No board attached");});
                        }
                    }
                }
            };
        ...
        function _SB_load_dependencies(GLOBAL, smartboardJSUrl, debugOn) {
            ...
            window.WEB_SOCKET_SWF_LOCATION = smartboardJSUrl + "lib/WebSocketMain.swf";
